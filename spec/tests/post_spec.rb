...
RSpec.describe Post, type: :model do
    ...
    it 'Should have not have more than 250 characters' do
        post.title = ""
    ...
    it 'Should display the last three comments done by subject' do
        comment1 = Comment.create(post: post, author: user, text: 'Hi Tom!' )
        comment2 = Comment.create(post: post, author: user, text: 'Hi Jerry!' )
        comment3 = Comment.create(post: post, author: user, text: 'Hi Sajeel!' )
        comment4 = Comment.create(post: post, author: user, text: 'Hi Saira!' )
        comment5 = Comment.create(post: post, author: user, text: 'Hi Cake!' )
        comment6 = Comment.create(post: post, author: user, text: 'Hi Raphael!' )
